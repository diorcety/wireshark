...
#define UDS_RC_ACTION_OFFSET (UDS_DATA_OFFSET + 0)
#define UDS_RC_ACTION_LEN 1
#define UDS_RC_ROUTINE_OFFSET (UDS_RC_ACTION_OFFSET + UDS_RC_ACTION_LEN)
#define UDS_RC_ROUTINE_LEN 2
#define UDS_RC_DATA_OFFSET (UDS_RC_ROUTINE_OFFSET + UDS_RC_ROUTINE_LEN)

#define UDS_RC_ACTIONS_START 1
#define UDS_RC_ACTIONS_STOP 2
#define UDS_RC_ACTIONS_REQUEST 3
...
#define UDS_CDTCS_ACTION_OFFSET (UDS_DATA_OFFSET + 0)
#define UDS_CDTCS_ACTION_LEN    1
