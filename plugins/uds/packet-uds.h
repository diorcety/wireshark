...
#define UDS_DSC_SUB_FUNCTION_OFFSET      (UDS_DATA_OFFSET + 0)
#define UDS_DSC_SUB_FUNCTION_LEN         1
#define UDS_DSC_PARAMETER_RECORD_OFFSET  (UDS_DSC_SUB_FUNCTION_OFFSET + UDS_DSC_SUB_FUNCTION_LEN)

#define UDS_DSC_SUB_FUNCTIONS_DEFAULT_SESSION                 1
#define UDS_DSC_SUB_FUNCTIONS_PROGRAMMING_SESSION             2
#define UDS_DSC_SUB_FUNCTIONS_EXTENDED_DIAGNOSTIC_SESSION     3
#define UDS_DSC_SUB_FUNCTIONS_SAFTY_SYSTEM_DIAGNOSTIC_SESSION 4

#define UDS_ER_SUB_FUNCTION_OFFSET   (UDS_DATA_OFFSET + 0)
#define UDS_ER_SUB_FUNCTION_LEN      1

#define UDS_ER_SUB_FUNCTIONS_HARD_RESET                   1
#define UDS_ER_SUB_FUNCTIONS_KEY_ON_OFF_RESET             2
#define UDS_ER_SUB_FUNCTIONS_SOFT_RESET                   3
#define UDS_ER_SUB_FUNCTIONS_ENABLE_RAPID_POWER_SHUTDOWN  4
#define UDS_ER_SUB_FUNCTIONS_DISABLE_RAPID_POWER_SHUTDOWN 5
